...
#    ]
    ...
    def parsePost(self,response):
        ...
        create_date = self.getDate(self.cleanText(" ".join(self.parseText(str=post.xpath('./article/span/time/@title').extract()[0]))))
        ...
        for post in posts:
            ...
            create_date = self.getDate(self.cleanText(" ".join(self.parseText(str=post.xpath('./article/span[2]/time/@title').extract()[0]))))
            item['create_date'] = create_date
