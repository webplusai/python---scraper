...
class ForumsSpider(CrawlSpider):
    ...
    def parsePostsList(self,response):
        ...
        create_date = self.getDate(self.cleanText(" ".join(response.xpath('.//table[@class="node node-forum"]//div[@class="date"]/span/text()').extract_first())))
        ...
        for post in posts:
            ...
            create_date = self.getDate(self.cleanText(" ".join(post.xpath('.//div[@class="date"]/span/text()').extract_first())))
            item['create_date'] = create_date
