...
class ForumsSpider(CrawlSpider):
    ...
    def parsePostsList(self,response):
        ...
        create_date = self.getDate(self.cleanText(" ".join(sel.xpath('//header[@class="node-header"]//time/text()').extract())))
        ...
        for post in posts:
            ...
            create_date = self.getDate(self.cleanText(" ".join(post.xpath('.//span[@class="date-time"]/text()').extract())))
            item['create_date'] = create_date
