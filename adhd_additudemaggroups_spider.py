...
class ForumsSpider(CrawlSpider):
    ...
    def parsePostsList(self,response):
        ...
        create_date = self.getDate(self.cleanText(" ".join(''.join(sel.xpath('.//span[@class="post-meta"]/text()').extract()).replace("Posted by","").replace("to",""))))
        ...
        for post in posts:
            ...
            create_date = self.getDate(self.cleanText(" ".join(''.join(post.xpath('.//span[@class="comment-meta"]/text()').extract()).replace("Posted by","").replace("to",""))))
            item['create_date'] = create_date
