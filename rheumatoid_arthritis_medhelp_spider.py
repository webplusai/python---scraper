...
#    ]
    ...
    def parsePost(self,response):
        ...
        create_date = self.getDate(self.cleanText(" ".join()))
        ...
        for post in posts:
            ...
            create_date = self.getDate(self.cleanText(" ".join(self.parseText(post.css('.post_byline').xpath('./span[3]/text()').extract()[0]))))
            item['create_date'] = create_date
